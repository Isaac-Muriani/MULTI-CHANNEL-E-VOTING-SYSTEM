...
<nav>
    <div class="nav-left">
        ...
        <div class="nav-links">
            ...
            <a href="export_results.php" class="nav-link <?= $current==='export_results.php' ?'active':'' ?>">Results</a>
            <?php if (($_SESSION['admin_role'] ?? '') === 'superadmin'): ?>
                <a href="manage_admins.php" class="nav-link <?= $current==='manage_admins.php' ?'active':'' ?>">Admins</a>
            <?php endif; ?>
        </div>
    </div>
    <div class="nav-right">
